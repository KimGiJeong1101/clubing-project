          ...
          {navItems.map((item) => (
            <Link
              ...
              className={`relative flex items-center justify-center h-full px-5 text-[14px] font-hanbit
                ...
                ${selected === item.name ? "text-gray-900 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-[70%] after:h-0.5 after:bg-gray-800" : "text-gray-500 hover:text-gray-900"}`}
            >
              {item.name}
            </Link>
          ))}
