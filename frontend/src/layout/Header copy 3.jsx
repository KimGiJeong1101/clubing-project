          ...
          >
            ...
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <Toolbar sx={{ padding: "0px !important", minWidth: "0" }}>
                ...
                >
                  <Typography variant="body2" component="div" sx={{ color: "gray", fontFamily: "KCC-Hanbit", fontWeight: 600 }}>
                    {homeLocation && homeLocation !== " " ? homeLocation : "미로그인"}
                  </Typography>
                </Box>
                ...
                <Tooltip title="알림" arrow>
                  <NotificationsIcon onClick={() => {}} sx={{ padding: "7px", color: "gray", ":hover": { cursor: "pointer" }, fontSize: 24 }} />
                </Tooltip>
