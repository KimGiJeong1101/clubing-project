  ...
  <footer className="bg-primary-100 text-primary-900">
    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.4fr] gap-10">
        ...
        <div>
          ...
          <div className="flex gap-2.5 mt-6">
            {[FiFacebook, FiTwitter, FiInstagram].map((Icon, i) => (
              <a key={i} href="#" className="w-9 h-9 rounded-full bg-primary-200 hover:bg-primary-500 hover:text-white flex items-center justify-center transition-all duration-200 text-primary-500">
        ...
        {/* ── 회사 ── */}
        <div>
          <h3 className="text-xs font-nanum-bold text-primary-400 uppercase tracking-widest mb-4">회사</h3>
        ...
        {/* ── 서비스 ── */}
        <div>
          <h3 className="text-xs font-nanum-bold text-primary-400 uppercase tracking-widest mb-4">서비스</h3>
          <ul className="space-y-2.5 text-sm text-primary-700">
            {[
              { label: "이벤트", to: "/event" },
        ...
        {/* ── 고객센터 ── */}
        <div>
          <h3 className="text-xs font-nanum-bold text-primary-400 uppercase tracking-widest mb-4">고객센터</h3>
          <div className="rounded-xl bg-white/60 border border-primary-200 px-4 py-4 space-y-3 text-sm text-primary-700">
            ...
            <p className="text-xs text-primary-400 pt-1 border-t border-primary-200">평일 09:00 – 18:00 (주말·공휴일 휴무)</p>
          </div>
        </div>
      </div>
