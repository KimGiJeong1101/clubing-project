      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between gap-2 mb-1">
          ...
          <span className="text-[0.65rem] text-gray-400 flex-shrink-0">
            {format(new Date(message.date), "MM.dd HH:mm")}
          </span>
        </div>

        {/* 제목 */}
        <p className="text-sm font-nanum-bold text-gray-800 truncate mb-1">
          {message.title}
        </p>
        ...
        <div className="flex items-end justify-between gap-2">
          ...
          <span
            className={`flex-shrink-0 text-[0.65rem] font-medium px-1.5 py-0.5 rounded-full ${
              message.isRead
