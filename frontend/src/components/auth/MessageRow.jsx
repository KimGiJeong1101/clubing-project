      ...
      <Grid container spacing={2} alignItems="flex-start">
        ...
        <Grid item xs={11}>
          ...
          >
            ...
            >
              <Typography sx={{ fontSize: "0.7rem" }}>From : {message.sender}</Typography>
              <Box sx={{ textAlign: "right" }}>
                <Typography sx={{ fontSize: "0.7rem", color: "textSecondary", mb: 1 }}>{format(new Date(message.date), "yyyy-MM-dd HH:mm")}</Typography>
              </Box>
              <Typography sx={{ fontSize: "0.7rem", fontWeight: "bold" }}>{message.title}</Typography>
            </Box>
            <Typography
              sx={{
                fontSize: "1rem",
