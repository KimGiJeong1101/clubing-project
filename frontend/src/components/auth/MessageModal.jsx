        ...
        <Grid container spacing={2} justifyContent="center">
          <Grid item sm={12}>
            ...
            >
              ...
              >
                <Typography sx={{ fontSize: "0.8rem" }}>to : {message.sender}</Typography>
                <Box sx={{ textAlign: "right" }}>
                  <Typography sx={{ fontSize: "0.8rem", color: "textSecondary", mb: 1 }}>{format(new Date(message.date), "yyyy-MM-dd HH:mm")}</Typography>
                </Box>
                <Typography sx={{ fontSize: "0.8rem", fontWeight: "bold" }}>{message.title}</Typography>
              </Box>
              <Typography
                sx={{
                  fontSize: "1.1rem",
