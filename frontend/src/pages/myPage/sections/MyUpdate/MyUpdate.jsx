...
import { TextField, Button, Typography, Box, Stack, FormControlLabel, FormControl, InputLabel, Select, MenuItem, FormHelperText, Chip } from "@mui/material";
              ...
              <Box sx={{ display: "flex", flex: 1, gap: 2, mt: 2 }}>
                ...
                <FormControl fullWidth variant="outlined" error={!!errors.age?.year}>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Select {...field} labelId="year-label" label="연도">
                ...
                <FormControl fullWidth variant="outlined" error={!!errors.age?.month}>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Select {...field} labelId="month-label" label="월">
                        <MenuItem value="">선택</MenuItem>
                        {months.map((month) => (
                ...
                <FormControl fullWidth variant="outlined" error={!!errors.age?.day}>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Select {...field} labelId="day-label" label="일">
                        <MenuItem value="">선택</MenuItem>
                        {days.map((day) => (
