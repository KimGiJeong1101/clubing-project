...
import { Box, Typography, Checkbox, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Grid, Dialog, DialogContent, IconButton, TablePagination } from "@mui/material";
  ...
  return (
    <Box>
      ...
      <Box sx={{ mt: 2, display: "flex", justifyContent: "center" }}>
        <CustomButton onClick={handleMarkAsRead} variant="contained" color="primary" sx={{ mr: 1 }}>
          읽음으로 표시
        </CustomButton>
        <CustomButton2 onClick={handleDelete} variant="contained" color="error">
          삭제
        </CustomButton2>
      </Box>
      ...
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", mt: 2 }}>
        ...
        <Box sx={{ display: "flex", alignItems: "center" }}>
          {Array.from({ length: totalPages }, (_, index) => (
            <IconButton key={index} onClick={() => setPage(index)} sx={{ mx: 0.5 }} color={page === index ? "primary" : "default"}>
