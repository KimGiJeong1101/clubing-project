...
import { TextField, Button, Typography, Box, Stack, IconButton, InputAdornment, FormControlLabel, FormControl, InputLabel, Select, MenuItem, FormHelperText, DialogActions, Chip, Checkbox, Paper, Link } from "@mui/material";
...
const RegisterPage = () => {
  ...
  const onSubmit = (data) => {
    ...
    const { email, password, name, age = {}, gender, homeLocation = {}, workplace = {}, interestLocation = {}, category = [], selectedJobs = [], phone = "", nickName } = data;
    ...
    >
      ...
      >
        ...
        <form className="mt-6" onSubmit={handleSubmit(onSubmit)}>
          <Box sx={{ mb: 2 }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", mt: 2 }}>
              ...
              <Stack direction="row" spacing={2}>
                {!isEmailChecked && (
                  <CustomButton2 variant="contained" color="primary" className="buttonMain" sx={{ height: "50px" }} onClick={handleCheckDuplicate}>
                    중복검사
                  </CustomButton2>
                )}
                {isEmailChecked && (
                  <Stack direction="column" spacing={0}>
                    ...
                    <CustomButton className="buttonSub2" sx={{ height: "25px" }} onClick={handleSendAuthEmail}>
                      인증하기
                    </CustomButton>
                  </Stack>
                )}
          ...
          {/* 비밀번호 */}
          <Box mb={2}>
            <Typography variant="body2" component="label" htmlFor="password" sx={{ fontWeight: "bold", color: "text.secondary" }}>
              비밀번호
            </Typography>
            <Box sx={{ display: "flex", alignItems: "center", mt: 2 }}>
              <TextField
            ...
            <Box sx={{ display: "flex", alignItems: "center", mt: 2 }}>
              <TextField
                ...
                InputProps={{
                  endAdornment: (
                    <InputAdornment position="end">
                      <IconButton onClick={handleClickShowPasswordCheck} edge="end">
          ...
          {/*이름 */}
          <Box mb={2}>
            <Typography variant="body2" component="label" htmlFor="name" sx={{ fontWeight: "bold", color: "text.secondary" }}>
              이름
            </Typography>
            <Box sx={{ display: "flex", alignItems: "center", mt: 2 }}>
              <TextField
          ...
          {/*닉네임 */}
          <Box mb={2}>
            <Typography variant="body2" component="label" htmlFor="nickName" sx={{ fontWeight: "bold", color: "text.secondary" }}>
              닉네임
            </Typography>
            <Box sx={{ display: "flex", alignItems: "center", mt: 2 }}>
              <TextField
              ...
              <Stack direction="row" spacing={2}>
                {!isNickNameReset ? (
                  !isNickNameChecked && (
                    <CustomButton2 variant="contained" color="primary" className="buttonMain" sx={{ height: "50px" }} onClick={handleCheckNickName}>
                      중복검사
                    </CustomButton2>
                  )
                ) : (
                  <>
                    <CustomButton2 variant="outlined" className="buttonSub1" sx={{ height: "50px" }} onClick={handleNickNameReset}>
                      닉네임 수정
                    </CustomButton2>
                  </>
                )}
          ...
          {/*생년월일 */}
          <Box mb={2}>
            <Typography variant="body2" component="label" htmlFor="age" sx={{ fontWeight: "bold", color: "text.secondary" }}>
              생년월일
            </Typography>
    ...
    />
          ...
          <Box>
            ...
            <Box mb={2} display="flex" alignItems="center" gap={2}>
              <CustomButton2 variant="contained" color="primary" onClick={() => handlePopupOpen("job")}>
                직종 선택
              </CustomButton2>
              <Typography variant="body2" sx={{ fontWeight: "bold", color: "text.secondary" }}>
                (최대 3개 선택 가능)
          ...
          <Box>
            {/* 카테고리 선택 버튼 */}
            <Box mb={2} display="flex" alignItems="center" gap={2}>
              <CustomButton2 variant="contained" color="primary" onClick={() => handlePopupOpen("category")}>
                카테고리 선택
              </CustomButton2>
              <Typography variant="body2" sx={{ fontWeight: "bold", color: "text.secondary" }}>
                3개 이상 선택해 주세요
          ...
          <Box mt={4}>
            <Box mb={2}>
              <FormControlLabel
                control={<CustomCheckbox checked={checkboxState.all} onChange={handleAllCheck} color="primary" />}
                label={
            ...
            <Box>
              <Box display="flex" alignItems="center">
                <FormControlLabel
                  control={<CustomCheckbox id="terms-checkbox" checked={checkboxState.terms} onChange={() => handleCheck("terms")} color="primary" />}
                  label={
                ...
                />
                <Button variant="text" color="primary" onClick={() => consentPopupOpen("terms")} sx={{ textDecoration: "underline" }}>
                  전체
                </Button>
              </Box>
            </Box>
            ...
            <Box>
              <Box display="flex" alignItems="center">
                <FormControlLabel
                  control={<CustomCheckbox id="privacy-checkbox" checked={checkboxState.privacy} onChange={() => handleCheck("privacy")} color="primary" />}
                  label={
                    <Typography variant="body1" component="span">
                      [필수] 개인정보 수집 및 이용
                    </Typography>
                ...
                />
                <Button variant="text" color="primary" onClick={() => consentPopupOpen("privacy")} sx={{ textDecoration: "underline" }}>
                  전체
                </Button>
              </Box>
            </Box>
            ...
            <Box mb={2}>
              <Box display="flex" alignItems="center">
                <FormControlLabel
                  control={<CustomCheckbox id="marketing-checkbox" checked={checkboxState.marketing} onChange={() => handleCheck("marketing")} color="primary" />}
                  label={
                    <Typography variant="body1" component="span">
                      [선택] 마케팅 동의
                    </Typography>
                  ...
                  sx={{ marginRight: 1 }} // 체크박스와 라벨 사이에 간격 추가
                />
                <Button variant="text" color="primary" onClick={() => consentPopupOpen("marketing")} sx={{ textDecoration: "underline" }}>
                  전체
                </Button>
              </Box>
            </Box>
          ...
          {/* 팝업 모달 */}
          {isPopupOpen.terms && <TermsPopup onClose={() => consentPopupClose("terms")} handleCheck={handleCheck} checked={{ terms: checkboxState.terms }} />}
          {isPopupOpen.privacy && <PrivacyPopup onClose={() => consentPopupClose("privacy")} handleCheck={handleCheck} checked={{ privacy: checkboxState.privacy }} />}
          ...
          {/*회원가입 버튼 */}
          <Box mt={6}>
            <CustomButton2 type="submit" variant="contained" sx={{ width: "100%", px: 4, py: 2, borderRadius: "8px" }}>
              회원가입
            </CustomButton2>

            <Typography mt={8} variant="body2" color="text.secondary" align="center" sx={{ fontWeight: "light" }}>
              아이디가 있다면?{" "}
