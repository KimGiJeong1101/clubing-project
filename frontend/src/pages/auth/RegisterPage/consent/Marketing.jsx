...
const MarketingPopup = ({ onClose, handleCheck, checked }) => {
  return (
    ...
    >
      <DialogTitle>마케팅 동의</DialogTitle>
      <DialogContent
        sx={{
          display: "flex",
      ...
      >
        ...
        <FormControlLabel control={<CustomCheckbox checked={checked.marketing} onChange={() => handleCheck("marketing")} color="primary" />} label="마케팅 정보 수신에 동의합니다." />
      </DialogContent>
      <DialogActions>
