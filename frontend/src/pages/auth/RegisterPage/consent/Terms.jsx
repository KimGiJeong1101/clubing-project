...
const TermsPopup = ({ onClose, handleCheck, checked }) => {
  return (
    ...
    >
      <DialogTitle>clubing 이용약관</DialogTitle>
      <DialogContent
        sx={{
          display: "flex",
      ...
      >
        ...
        <FormControlLabel control={<CustomCheckbox checked={checked.terms} onChange={() => handleCheck("terms")} color="primary" />} label="약관에 동의합니다." />
      </DialogContent>
      <DialogActions>
