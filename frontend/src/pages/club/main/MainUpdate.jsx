      ...
      <div className="max-w-screen-md mx-auto mt-5 px-4 pb-10">
        ...
        <div className="grid grid-cols-1 gap-y-4">
          ...
          <div className="grid grid-cols-[auto_1fr] items-center gap-x-4">
            ...
            <div>
              <HomeSearchClub
                initialSido={homeLocation.sido}
                initialSigoon={homeLocation.sigoon}
                initialDong={homeLocation.dong}
          ...
          <div>
            ...
            <label
              htmlFor="img"
              className="block w-full border border-gray-300 rounded text-center py-2 cursor-pointer hover:bg-gray-50 transition-colors mb-2"
            >
            ...
            {!preview && (
              <div
                ...
                onDrop={handleDrop}
                className="w-full h-[478.5px] flex items-center justify-center mt-2"
              >
                <img
                  src={`http://localhost:4000/` + noUpdatePreview}
                  alt="미리보기"
