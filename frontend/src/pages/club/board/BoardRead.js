        ...
        <>
          ...
          {isAuthor && (
            <div className="mt-5 flex justify-end gap-2 pt-4 border-t border-gray-100">
              <button onClick={handleOpenEditModal} className="px-4 py-2 rounded-lg text-sm font-medium bg-primary-50 text-primary-700 hover:bg-primary-100 transition-colors">
                수정
              </button>
              <button onClick={handleDelete} className="px-4 py-2 rounded-lg text-sm font-medium bg-red-50 text-red-600 hover:bg-red-100 transition-colors">
                삭제
              </button>
            </div>
          )}
          ...
          <div className="mt-5 pt-4 border-t border-gray-100">
            <button onClick={handleToggleReply} className="flex items-center gap-2 text-sm text-gray-500 hover:text-primary-600 transition-colors font-medium">
