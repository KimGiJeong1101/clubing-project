              ...
              {!isVoteEnded ? (
                <>
                  {!hasVoted ? (
                    ...
                    <button onClick={handleRemoveVote} className="px-4 py-2 rounded text-sm font-medium bg-primary-100 text-primary-800 hover:bg-primary-200 transition-colors">
                      투표 취소하기
                    </button>
                  )}
                </>
