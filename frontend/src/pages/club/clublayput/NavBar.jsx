        ...
        {navItems.map((item) => (
          <Link
            ...
            className={`relative flex items-center justify-center h-full w-1/4 text-sm font-hanbit
              ...
              ${selected === item.name
                ? "text-primary-700 font-nanum-bold after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-[60%] after:h-0.5 after:bg-primary-600 after:rounded-full"
